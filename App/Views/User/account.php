...
<head>
    ...
    <link
        rel="shortcut icon"
        href="/perpustakaan-jp/public/logo 1.png"
        type="image/x-icon" />
    <!-- Font Family -->
        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen">
            ...
            <div
                ...
                <div class="flex items-center justify-center pt-8 mb-8">
                    <img src="/perpustakaan-jp/public//logo 1.png" alt="" />
                </div>
                  ...
                  <div class="flex flex-col gap-4 px-4 py-8">
                    ...
                    <a
                        ...
                        <svg class="fill-current <?php echo $current_page == 'account.php' ? 'fill-white' : 'text-slate-500 group-hover:fill-white'; ?> group-hover:fill-white " width="24" height="24" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                <header class="flex items-center justify-between px-6 py-3 md:py-0">
                ...
                <!-- Main Content Start -->
                <form action="" method="post" class="overflow-y-auto" enctype="multipart/form-data">
                    <main
                        ...
                        <div class="flex-1 pt-1 md:pt-6 mb-8">
                            ...
                            <!-- Content Foto Start -->
                            <div
                                class="w-full h-[197px] bg-pinkSec rounded-md relative pt-4 pr-6">

                                <div class="flex justify-center">
                                    <div
                                        class="w-[123px] h-[123px] rounded-full absolute -bottom-1/4 group cursor-pointer">
                                        <div class="w-full h-full absolute bottom-0 rounded-full bg-black bg-opacity-25 hidden group-hover:flex justify-center items-center transition-all duration-500 p-1">
                                            <i class="fa-solid fa-camera-rotate text-3xl text-white"></i>
                                        </div>
                                        <img
                                            id="profileImage"
                                            src="<?php echo htmlspecialchars($user['profil_user'] ?? '../../../public/profile/default.png'); ?>"
                                            class="w-full h-full object-cover rounded-full"
                                            alt="" />
                                        <label for="profil_user" class="rounded-full absolute inset-0 bg-black bg-opacity-25 flex items-center justify-center text-white cursor-pointer opacity-0 hover:opacity-100 transition-opacity">
                        ...
                        <div class="flex justify-end mb-10">
                            <button
                                ...
                                class="px-4 py-2 bg-primaryBlue text-white rounded-md">
                                Simpan
                            </button>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 md:gap-3 lg:gap-4 xl:gap-6">
                            <!-- Form 1 Start -->
                            <div
                                class="w-full px-6 lg:px-10 xl:px-14 py-8 bg-inputColors rounded-lg mb-4 md:mb-0">
                                <!-- Header Start -->
                                <div class="">
                                ...
                                <div class="flex flex-col gap-3 mb-8 md:mb-14">
                                    <label
                            ...
                            <div
                                ...
                                <!-- Header Start -->
                                <div class="">
                                    <h2 class="font-bold text-[20px] mb-8">Detail Akun</h2>
                                </div>
                                <!-- Header End -->
